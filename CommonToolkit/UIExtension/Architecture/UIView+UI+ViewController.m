...
- (void)handleGestureRecognizer:(UIGestureRecognizer *)pGestureRecognizer{
    ...
    // pan
        ...
        if (pGestureRecognizer.state == UIGestureRecognizerStateChanged) {
            ...
            _newFrame.origin.x = MIN(MAX(_newFrame.origin.x + _translation.x, 0.0), pGestureRecognizer.view.superview.frame.size.width - pGestureRecognizer.view.frame.size.width);
            _newFrame.origin.y = MIN(MAX(_newFrame.origin.y + _translation.y, 0.0), pGestureRecognizer.view.superview.frame.size.height - pGestureRecognizer.view.frame.size.height);
            ...
            _newFrame.origin.x = MIN(MAX(_newFrame.origin.x + _combineVelocity * _velocity.x / (2 * _acceleration), 0.0), pGestureRecognizer.view.superview.frame.size.width - pGestureRecognizer.view.frame.size.width);
            _newFrame.origin.y = MIN(MAX(_newFrame.origin.y + _combineVelocity * _velocity.y / (2 * _acceleration), 0.0), pGestureRecognizer.view.superview.frame.size.height - pGestureRecognizer.view.frame.size.height);
